...
function retaNaHorizontal(tamanho,x,y) {
  for (let y = 0; y < tamanho; y++) {
    ...
    mapaFaseUm[x][y] = "<span class = 'parede'>*</span>";
  };
}
...
mapaFaseUm[11][5] = " ";
mapaFaseUm[7][2] = "<span class = 'portaF'>D</span>";
mapaFaseUm[13][13] = "<span class = 'chave'>@</span>";
mapaFaseUm[9][1] = "<span class = 'chave'>@</span>";
mapaFaseUm[11][11] = "<span class = 'portaF'>D</span>";
mapaFaseUm[8][7] = " ";
mapaFaseUm[1][7] = "<span class = 'portaF'>D</span>";
mapaFaseUm[3][12] = "<span class = 'portaF'>D</span>";
mapaFaseUm[3][3] = " ";
mapaFaseUm[4][7] = " ";
mapaFaseUm[6][13] = "<span class = 'chave'>@</span>";
mapaFaseUm[1][1] = "<span class = 'chave'>@</span>";
mapaFaseUm[1][14] = "=";
...
window.addEventListener("keydown", function testePersonagem(event) {
  ...
  if (teclaPressionada === 87) {
    ...
    if (boolNoClip == false) {
      ...
      if (mapaFaseUm[linha - 1][coluna] !== "<span class = 'parede'>*</span>" && mapaFaseUm[linha - 1][coluna] !== "<span class = 'portaF'>D</span>") {
  ...
  if (teclaPressionada === 68) {
    ...
    if (boolNoClip == false) {
      ...
      // de <span class = 'parede'>*</span> e D
      if (mapaFaseUm[linha][coluna + 1] !== "<span class = 'parede'>*</span>" && mapaFaseUm[linha][coluna + 1] !== "<span class = 'portaF'>D</span>") {
        coluna++;
        geracaoDoMapa();
      };
    } else {
    ...
    if (linha === 1 && coluna === 14) {
      this.window.location.href  = "cutscene2.html";
    };
  };
  ...
  if (teclaPressionada === 73) {
    ...
    else if (linha === 10 && coluna === 13){
      this.document.getElementsByClassName("textoDica")[0].classList.add("textoDicaAdd");
      this.document.getElementById('charada').innerHTML = '"O caminho é longo, mas para  <br>uma boa jornada comece por baixo"'
    }
