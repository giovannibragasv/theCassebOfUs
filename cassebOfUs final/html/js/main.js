...
function jogarFaseTres(params) {
    location.href = "marley.html"; 
}
...
function traduzirMarley(params){
    let fraseUm = document.getElementsByClassName("fraseUm")[0];
    let fraseDois = document.getElementsByClassName("fraseDois")[0];
    let fraseTres = document.getElementsByClassName("fraseTres")[0];
    let fraseQuatro = document.getElementsByClassName("fraseQuatro")[0];
    ...
    fraseUm.innerHTML = "Você está quase chegando em mim!";
    fraseDois.innerHTML = "Já consigo sentir o seu cheiro";
    fraseTres.innerHTML = "Droga, o Girroto já sabe que você está chegando!";
    fraseQuatro.innerHTML = "Ah não! Ele já sabia de tudo! Era tudo um grande plano";
    fraseCinco.innerHTML = "Ele está invadindo a conexão!!";

    document.getElementById("textoBotaoTraducao").style.display = "none";

    document.getElementById("botaoJogar").innerHTML = " <button  class='botaoJogar' onclick='Girras()'><div class='textb'>CONTINUAR</div></button> "; 
}
function Girras(params) {
        ...
        let fraseQuatro = document.getElementsByClassName("fraseQuatro")[0];
        let fraseCinco = document.getElementsByClassName("fraseCinco")[0];
        let Giras = document.getElementsByClassName("Giras")[0]; 

        fraseUm.innerHTML = "Finalmente nos encontramos novamente, Casseb.";
        fraseDois.innerHTML = "Você está preparado para passar pela última fase para recuperar seu precioso cachorro?";
        fraseTres.innerHTML = "A sala a seguir tem armadilhas de todo o tipo para te impedir de pega-lo";
        fraseQuatro.innerHTML = "Se você vacilar, Caminito será para sempre meu!!";
        fraseCinco.innerHTML = "Se prepare, Casseb...";
        Giras.innerHTML = "<img src='https://i.picasion.com/pic92/cf80702312e477e6730551bdf0ada978.gif' class='imagemCachorro'>";
        document.getElementById("textoBotaoTraducao").style.display = "none"; 
        document.getElementById("botaoJogar").innerHTML = " <button  class='botaoJogar' onclick='jogarFaseTres()'><div class='textb'>JOGAR</div></button> "
}
